...
import com.airflights.auth.dto.ChangePasswordRequestDto;
...
import com.airflights.auth.mapper.UserMapper;
...
public class UserService {
    ...
    public UserDto setRoles(Long id, UpdateUserRolesRequestDto dto) {
    ...
    public UserDto setManagedDepartments(Long id, Set<Long> managedDeptIds) {
        AppUser appUser = getOrThrow(id);
