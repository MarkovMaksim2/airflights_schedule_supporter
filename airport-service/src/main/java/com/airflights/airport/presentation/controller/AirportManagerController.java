...
public class AirportManagerController {
    ...
    private final AirportManagerUseCase airportManagerUseCase;
    private final AirportManagerPresentationMapper airportManagerPresentationMapper;

    @GetMapping("/by-email")
    @Operation(summary = "Get airport manager by email")
    public Mono<AirportManagerResponse> getByEmail(@RequestParam String email) {
        return airportManagerUseCase.getByEmail(email)
                .map(airportManagerPresentationMapper::toResponse);
    }
    ...
    public Mono<AirportManagerResponse> create(@Valid @RequestBody AirportManagerRequest request) {
        return airportManagerUseCase.create(airportManagerPresentationMapper.toDto(request))
                .map(airportManagerPresentationMapper::toResponse);
    }
    ...
    public Mono<Void> delete(@PathVariable Long id) {
        return airportManagerUseCase.delete(id);
    }
}
