...
import com.airflights.airport.service.FlightActionService;
...
public class AirportFlightActionController {
    ...
    private final FlightActionService flightActionService;
    ...
    public Mono<Void> approve(
        ...
        return flightActionService.requestFlightAction(id, FlightAction.APPROVE, userEmail);
    }
    ...
    public Mono<Void> depart(
        ...
        return flightActionService.requestFlightAction(id, FlightAction.DEPART, userEmail);
    }
    ...
    public Mono<Void> arrive(
        ...
        return flightActionService.requestFlightAction(id, FlightAction.ARRIVE, userEmail);
    }
}
